final Map<String, String> kmKH = {
  ...
  'user_already_exists': 'គណនីនេះត្រូវបានចុះឈ្មោះរួចហើយ។ សូមចូលប្រើប្រាស់។',
  'incomplete_verification_title': 'ការផ្ទៀងផ្ទាត់មិនទាន់បញ្ចប់',
  'incomplete_verification_message':
      'អ្នកបានចុះឈ្មោះជាមួយលេខទូរស័ព្ទនេះរួចហើយ ប៉ុន្តែមិនទាន់បានបញ្ចប់ការផ្ទៀងផ្ទាត់ទេ។ តើអ្នកចង់ផ្ទៀងផ្ទាត់ឥឡូវនេះទេ?',
  'verify_now': 'ផ្ទៀងផ្ទាត់ឥឡូវនេះ',
  ...
  'login_via_phone': 'លេខទូរស័ព្ទ',
  'login_via_email': 'អ៊ីមែល',
  'select_country': 'ជ្រើសរើសប្រទេស',
  'search_country': 'ស្វែងរកប្រទេស ឬលេខកូដ...',
  ...
  'email_or_phone_required': 'សូមបញ្ចូលអ៊ីមែល ឬលេខទូរស័ព្ទ',
  'phone_required': 'សូមបញ្ចូលលេខទូរស័ព្ទ',
  'invalid_email_or_phone': 'អ៊ីមែល ឬលេខទូរស័ព្ទមិនត្រឹមត្រូវ',
  'invalid_phone': 'លេខទូរស័ព្ទមិនត្រឹមត្រូវ',
  'school_id_required': 'សូមបញ្ចូលលេខសម្គាល់សាលា',
  ...
  'pay_with_khqr': 'ទូទាត់ជាមួយ Bakong KHQR',
  'scan_to_pay': 'ស្កេនជាមួយកម្មវិធីធនាគារណាមួយដើម្បីទូទាត់',
  'payment_successful': 'ការទូទាត់ជោគជ័យ!',
  'subscription_activated_msg': 'ការជាវត្រូវបានបើកដំណើរការដោយជោគជ័យ! រីករាយជាមួយមុខងារពិសេសទាំងអស់។',
  'waiting_for_payment': 'កំពុងរង់ចាំការទូទាត់...',
  'verify_payment_btn': 'ខ្ញុំបានទូទាត់រួចហើយ',
  'simulate_payment_btn': 'សាកល្បងទូទាត់ (Test Mode)',
  'qr_expires_in': 'ផុតកំណត់ក្នុងរយៈពេល',
  'qr_expired_msg': 'កូដ QR នេះបានផុតកំណត់ហើយ។ សូមបង្កើតម្តងទៀត។',
  'generating_qr': 'កំពុងបង្កើត KHQR...',
  'save_qr_btn': 'ទាញយក QR',
  'qr_saved_success': 'បានរក្សាទុក QR កូដក្នុងវិចិត្រសាលរូបភាពជោគជ័យ!',
  'qr_save_failed': 'មិនអាចរក្សាទុករូបភាពបានទេ។ សូមពិនិត្យមើលការអនុញ្ញាត។',
  'resume_pending_payment': 'បន្តការទូទាត់ដែលនៅសល់',
  'pending_payment_found': 'អ្នកមានការទូទាត់ KHQR ដែលមិនទាន់បញ្ចប់',
