final Map<String, String> enUS = {
  ...
  'verification_sent_to': 'A verification link was sent to',
  'check_spam_folder': 'Please also check your spam or junk folder.',
  'resend_verification_email': 'Resend Verification Email',
  'verification_email_resent': 'Verification email resent! Please check your inbox.',
  'email_already_verified': 'Your email is already verified. Please try logging in.',
  ...
  'phone': 'Phone',
  'register_via_phone': 'Phone Number',
  'register_via_email': 'Email Address',
  'login_via_phone': 'Phone',
  'login_via_email': 'Email',
  'select_country': 'Select Country',
  'search_country': 'Search country or code...',
  'add_optional_email': '+ Add Email (Optional recovery)',
  'add_optional_phone': '+ Add Phone Number (Optional)',
  'remove_secondary_contact': '- Remove secondary contact',
  'address': 'Address',
  'birthday': 'Birthday',
  'gender': 'Gender',
  'male': 'Male',
  ...
  'out_of_hearts_desc': 'You have 0 hearts left. Wait for them to recover or upgrade to Premium for Unlimited Hearts!',
  'next_heart_in': 'Next heart in',
  'get_unlimited_hearts': 'Get Unlimited Hearts',
  'wait_for_timer': 'Wait for Hearts',
  'unlimited': 'Unlimited',
  ...
  'benefit_worlds_title': 'Unlimited hearts for practice',
  ...
  'pay_with_khqr': 'Pay with Bakong KHQR',
  'scan_to_pay': 'Scan with any banking app to pay',
  'payment_successful': 'Payment Successful!',
  'subscription_activated_msg': 'Your subscription is now active! Enjoy unlimited hearts, games, and AI writing.',
  'waiting_for_payment': 'Waiting for payment confirmation...',
  'verify_payment_btn': 'I Have Paid',
  'simulate_payment_btn': 'Simulate Payment (Test Mode)',
  'qr_expires_in': 'Expires in',
  'qr_expired_msg': 'This QR code has expired. Please generate a new one.',
  'generating_qr': 'Generating KHQR...',
  'save_qr_btn': 'Save QR',
  'qr_saved_success': 'QR Code saved to Photos! Open your banking app to scan from gallery.',
  'qr_save_failed': 'Failed to save QR image. Please check photo permissions.',
  'resume_pending_payment': 'Resume Pending Payment',
  'pending_payment_found': 'You have an active pending KHQR payment',
